...
exports.allUsers = (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const users = yield userModel_1.User.find(keyword).find({ _id: { $ne: req.user._id } });
    res.send(users);
}));
